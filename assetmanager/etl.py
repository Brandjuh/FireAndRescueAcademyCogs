...
_NON_LITERAL_PATTERNS = [
    ...
    r"`",                      # template literal
    r"\bimport\b",             # imports present
    r"\bconst\b|\blet\b|\bvar\b",  # declarations inside object region
]
...
def transform_vehicles(src: Dict[str, Any]) -> Tuple[
    ...
    for k, v in src.items():
        ...
        vehicles[vid] = {
            "id": vid, "name": name, "min_personnel": min_p or 0, "max_personnel": max_p or 0,
            "price_credits": price_credits, "price_coins": price_coins, "rank_required": rank_required,
            "water_tank": water_tank, "foam_tank": foam_tank, "pump_gpm": pump_gpm, "speed": speed, "specials": specials,
        }
